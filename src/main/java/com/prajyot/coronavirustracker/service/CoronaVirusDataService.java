package com.prajyot.coronavirustracker.service;

import com.prajyot.coronavirustracker.model.LocationStats;
...
public class CoronaVirusDataService {
    ...
    public void fetchVirusData() throws Exception {
        ...
        for (CSVRecord record : records) {
            ...
            locationStats.setLatestTotalCases(latestCount);
            locationStats.setDiffFromPrevDay(latestCount - prevCount);
